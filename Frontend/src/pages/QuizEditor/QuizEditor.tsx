      ...
      const response = await fetch(
        "https://quizzler-backend-1.onrender.com/api/quizzes/complete",
        {
          ...
          headers: {
            ...
            Authorization:
              `Bearer ` +
              "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjIsImlhdCI6MTczODA3MzY3NiwiZXhwIjoxNzM4MDc3Mjc2fQ.CtbwtJH70WNczaUMxtGzuFAt1uw4RZ29ZY-ZEXLZixA",
            Origin: "*",
          },
        ...
        <div className="max-w-4xl mx-auto p-4">
          <Card title="Utwórz nowy quiz">
            ...
            <div className="mt-8 flex justify-end gap-4">
              {currentStep > 0 && <Button onClick={prev}>Cofnij</Button>}
