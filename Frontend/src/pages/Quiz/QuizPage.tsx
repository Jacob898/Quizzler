        ...
        {!quizData ? (
          ...
          <div style={{ textAlign: "center", width: "100%" }}>
            ...
            <div className="quiz-description">
              ...
              <Button type="primary" className="solve-quiz-button">
            ...
            >
              <h2>Komentarze</h2>
              <Rate
                className={`custom-rate ${getRatingClass(rating)}`}
                value={rating}
                onChange={setRating}
              />
              <Input.TextArea
              ...
              {reviews.length === 0 ? (
                ...
                reviews.map((review) => (
                  ...
                  >
                    ...
                    <Rate
                      className={`custom-rate ${getRatingClass(review.stars)}`}
                      value={review.stars}
                      disabled
                      style={{ fontSize: "14px" }}
                    />
                    ...
                    {review.User.email === username && (
                      <Button
                        onClick={() =>
                          handleDeleteReview(review.quiz_review_id)
                        }
                        danger
                      >
                        Usuń opinię
